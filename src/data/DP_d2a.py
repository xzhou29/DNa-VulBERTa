...
def main():
    ...
    parser.add_argument('--input', required=False, help='dataset.json',
                        default='..\\cbert\\datasets\\d2a\\DAX_D2ALBData\\function\\d2a_lbv1_function_train.csv')
    parser.add_argument('--output', required=False, help='xxx.pkl',
                        default="..\\cbert\\DNa_data\\d2a.pkl")
    ...
    new_data_collections = Parallel(n_jobs=args.workers)\
            (delayed(de_naturalize.data_extractor)(i, 'd2a_function_{}'.format(data['id'][i]),
